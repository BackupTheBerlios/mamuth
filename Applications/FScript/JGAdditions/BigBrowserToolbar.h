...
//  RubatoFrameworks
//
//  BigBrowserToolbar.h Copyright (c) 2002 Joerg Garbers.
//  This software is open source. See the license.

#import <Cocoa/Cocoa.h>
#import "BigBrowserView.h"

@interface BigBrowserView (ToolbarController)
- (BOOL)doSetupToolbar;
...
// accumulator:={}. collectSelection := [:x | accumulator addObject:x]. BigBrowserView addCustomBlockMenuIdentifier:'collectSelection'.
